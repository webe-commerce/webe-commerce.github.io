# WeBeCommerce - Your E-Commerce Store

เว็บไซต์ร้านค้าออนไลน์แนะนำสินค้าคุณภาพ พร้อมระบบ Affiliate Marketing  
สร้างด้วย HTML, CSS และ JavaScript | Deploy ฟรีบน GitHub Pages

**ไฮไลท์:** สินค้าขายดีแสดงที่หน้าแรก | ปุ่มซื้อขนาดใหญ่ | Platform badges บนรูปภาพ | SEO Optimized
...
- **Best Sellers Section** - สินค้าขายดี ยอดนิยม แสดงที่หน้าแรก (top 6 อัตโนมัติ)
- **Products First** - สินค้าแสดงทันทีหลัง hero section (ไม่ต้องเลื่อน)
- **Prominent Buy Buttons** - ปุ่ม "ซื้อเลย" ขนาดใหญ่ ชัดเจน
- **Platform Badges on Images** - แสดงแหล่งที่มาเฉพาะบนรูปสินค้า (ไม่มีข้อความ)
- **Category Filtering** - กรองสินค้าตามหมวดหมู่ 6 หมวด
...
### 🏷️ [GTM_SETUP.md](GTM_SETUP.md)
คู่มือติดตั้ง Google Tag Manager
- What is GTM and why use it
- Quick setup ใน 10 นาที
- วิธีเพิ่ม Tags, Triggers, Variables
...
- Platform Badges บนรูปสินค้าเท่านั้น
- Customer Journey Analysis

### 🔥 [BEST_SELLERS_FEATURE.md](BEST_SELLERS_FEATURE.md)
คู่มือฟีเจอร์สินค้าขายดี ยอดนิยม
- Best Sellers Section ที่หน้าแรก
- การเลือกสินค้า Top 6 อัตโนมัติ
- การปรับแต่งและ Customization
- Expected Impact และ Metrics
- Pro Tips สำหรับเพิ่มยอดขาย

### 🏪 [WEBSITE_OVERVIEW.md](WEBSITE_OVERVIEW.md)
ภาพรวมเว็บไซต์และโครงสร้าง
- Website Structure และ File Organization
- Product Data Format
- Deployment Guide
- Growth Strategy
- Quick Reference
